...
public class AndroidUtilities {
    ...
    private static File getAlbumDir(boolean secretChat) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            storageDir = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), "Calegram");
            ...
            if (data != null) {
                ...
                if (scheme != null) {
                    if ((scheme.equals("http") || scheme.equals("https"))) {
                        ...
                        if (host.equals("Calegram.me") || host.equals("t.me") || host.equals("Calegram.dog")) {
